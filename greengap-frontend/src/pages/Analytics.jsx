      ...
      <div className="insights-section">
        ...
        <div className="insight-card">
          ...
          <div className="insight-content">
            ...
            <p>Your energy efficiency has decreased by 3% over the last week. 
               This may indicate rebound effects from recent behavior changes.</p>
          </div>
        </div>
        ...
        <div className="insight-card">
          ...
          <div className="insight-content">
            ...
            <p>Detected unusual spike in consumption on weekends. 
               Consider implementing automated controls during off-peak hours.</p>
          </div>
        </div>
        ...
        <div className="insight-card positive">
          ...
          <div className="insight-content">
            ...
            <p>You've saved {data?.summary_cards?.co2_saved?.toFixed(2) || "0"} kg CO₂ 
               compared to baseline. Keep up the good work!</p>
          </div>
        </div>
      </div>
    </div>
